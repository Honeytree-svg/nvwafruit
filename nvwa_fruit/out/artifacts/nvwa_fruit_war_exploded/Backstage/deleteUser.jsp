        ...
        <div class="tabs">
            <div class="hd">
                <ul>
                    ...
                    <li class="on" style="box-sizing: initial;-webkit-box-sizing: initial;"><a  href="Person?identification=1&&category=0">删除用户</a></li>
                    ...
                    <li class="" style="box-sizing: initial;-webkit-box-sizing: initial;"><a  href="Person?type=addadmin&&category=0">添加管理员</a></li>
                </ul>
            </div>
            <div class="bd">
                        ...
                        <div id="dv1">
                            <table class="table" id="tbRecord">
                                ...
                                <tr>
                                    ...
                                    <td class="delete"><a class="btn btn-default btn-xs" href="Person?type=delete&&iduser=<%=person.getId()%>&&identification=1">删除</a></td>
                                </tr>
                                <%
                                            i++;
                                        }}%>
                                <tr>
                                    <td colspan="5" align="center">
                                        <a href="Person?page=1&&identification=1"><span>&laquo;</span></a>
                                        <%
                                            int i=1;
                                            while (i<=pageCount){
                                        %>
                                        <a href="Person?page=<%=i%>&&identification=1"><%=i%></a>
                                        <%i++;
                                        }
                                        %>
                                        <a href="Person?page=<%=pageCount%>&&identification=1"><span>&raquo;</span></a>
                                    </td>
                                </tr>
                                </tbody>

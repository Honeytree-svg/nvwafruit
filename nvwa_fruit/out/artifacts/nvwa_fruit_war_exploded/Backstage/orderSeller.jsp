...
<div class="dvcontent">
    ...
    <div>
        ...
        <div class="tabs">
            <div class="hd">
                <ul>
                    <li class="on" style="box-sizing: initial;-webkit-box-sizing: initial;"><a  href="Order?orderState=0">代发货订单</a></li>
                    <li class="" style="box-sizing: initial;-webkit-box-sizing: initial;"><a  href="Order?orderState=2">待退货订单</a></li>
                </ul>
            </div>
            <div class="bd">
                    ...
                    <li>
                        ...
                        <div id="dv1">
                            <table class="table" id="tbRecord">
                                ...
                                %><tr><td colspan="6">暂时没有任何订单！</td></tr>
                                    <%} else{
                                        int i=0;
                                        Order order=null;
                                        while (i<list.size()){
                                ...
                                <tr>
                                    ...
                                    <td class="delete">
                                        <a  href="Order?type=update_do&&idorder=<%=order.getIdorder()%>&&state=1">发货</a>
                                    </td>
                                </tr>
                                <%
                                            }
                                ...
                                <tr>
                                    <td colspan="6" align="center">
                                        <a href="Order?page=1&&identification=0&&orderState=0"><span>&laquo;</span></a>
                                        <%
                                            int i=1;
                                            while (i<=pageCount){
                                        %>
                                        <a href="Order?page=<%=i%>&&identification=0&&orderState=0"><%=i%>||</a>
                                        <%i++;
                                        }
                                        %>
                                        <a href="Order?page=<%=pageCount%>&&identification=0&&orderState=0"><span>&raquo;</span></a>

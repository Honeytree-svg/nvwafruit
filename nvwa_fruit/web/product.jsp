                ...
                <table width="800px">
                    <tr>
                        <td  align="center" style="font-size: 15px;">
                            ...
                            <a href="Merchandise?type=selectCategory&&page=1&&idcategory=<%=merchandiseList.get(0).getCategory()%>">首页</a>
                            <%
                                i=1;
                                while (i<=pageCount){
                            %>
                            <a href="Merchandise?type=selectCategory&&page=<%=i%>&&idcategory=<%=merchandiseList.get(0).getCategory()%>"><%="第"+i+"页"%></a>
                            <%
                                    i++;
                                }%>
                            <a href="Merchandise?type=selectCategory&&page=<%=pageCount%>&&idcategory=<%=merchandiseList.get(0).getCategory()%>">尾页</a>
                        </td>
                    </tr>
                </table><!--  分页栏！！！！！ -->
                <div class="clears"></div>

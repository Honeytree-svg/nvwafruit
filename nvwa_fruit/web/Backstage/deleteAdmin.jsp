        ...
        <div class="tabs">
            <div class="hd">
                <ul>
                    ...
                    <li class="on" style="box-sizing: initial;-webkit-box-sizing: initial;"><a  href="Person?identification=0&&category=0">删除管理员</a></li>
                    ...
                    <li>
                        ...
                        <div id="dv1">
                            <table class="table" id="tbRecord">
                                ...
                                %><tr><td colspan="5">暂时没有任何管理员注册！</td></tr>
                                <tr>
                                    <%}
                                    else{
                                        int i=0;
                                    ...
                                    <td class="delete"><a class="btn btn-default btn-xs" href="Person?type=delete&&iduser=<%=person.getId()%>&&identification=0">删除</a></td>
                                </tr>
                                <%
                                            i++;
                                        }}%>
                                <tr>
                                    <td colspan="5" align="center">
                                        <a href="Person?page=1&&identification=0"><span>&laquo;</span></a>
                                        <%
                                            int i=1;
                                            while (i<=pageCount){
                                        %>
                                        <a href="Person?page=<%=i%>&&identification=0"><%=i%></a>
                                        <%i++;
                                        }
                                        %>
                                        <a href="Person?page=<%=pageCount%>&&identification=0"><span>&raquo;</span></a>
                                    </td>
                                </tr>
                                </tbody>
